...
<!--            <button id="register" class="roundcorner" type="button" value="Register">REGISTER</button>-->
            <a href="master_separate.php"><button id="posting" class="roundcorner" type="button">POST</button></a>
<!--            <figure><img id="pencil" src="img/home/post.png" alt="Post icon"></figure>-->
            <h3 class="personRegister">
                <?php
    ...
    <!--desert top5 starts-->                 
                    <div id="desert" class="clearfix">
                        ...
                        <?php 
                        // COUNT THE NUMBER OF RECIPES DISPLAYED IN THE TOP ROW (1 - 4)
                        $recipesCountRowTop = 0; 
                                    ...
                                    <ul class="rankBottom">
                                        ...
                                        <li>
                                            ...
                                            <form id="recipe1" action="rate-recipe.php" action="post">
                                                <input type="hidden" name="idRecipe" value="<?php echo $recipe['idRecipe']?>" />                                                                                                
                    ...
                    <div id="noodle" class="clearfix">
                        ...
                        <!--noodle Mexican Lasagna-->
                         <?php 
                        // COUNT THE NUMBER OF RECIPES DISPLAYED IN THE TOP ROW (5 - 8)
                        $recipesCountRowBottom = 5; 
                            ...
                            <div class="rankMain">
                                <a href="recipe_<?php echo $recipe2['idRecipe']?>.php" target="right"> 
                                    ...
                                    <ul class="rankBottom">
                                        ...
                                        <li><img id="calory" src="img/home/calory.png" alt="Calory" /></li>
                                        <li><img id="favorite" src="img/home/fav.png" alt="Favorite" /></li>
                                        <form id="recipe<?php echo $recipesCountRowBottom; ?>" action="rate-recipe.php" action="post">
                                            <input type="hidden" name="idRecipe" value="<?php echo $recipesCountRowBottom; ?>" />                                                                                                
                                            <input type="image" form="recipe<?php echo $recipesCountRowBottom; ?>" name="rate" src="img/home/content_icon.png" alt="Rate" /> 
                                        </form>
                                    </ul>
                                </a>
                            </div>
                        ...
                        <?php 
                        // INCREASE THE RECIPE COUNT FOR THE BOTTOM ROW
                        $recipesCountRowBottom++;
                        endforeach;?>
