<?php
    //Start codes for a login. Please do not remove this!!!
    require_once '../Class_Folder/loginClass.php';
    require_once '../Class_Folder/database.php';
    session_start();
    $user = new loginClass();
    $allusers = $user->getLogin();
    //End codes for a login
    
    //Your own php code for your features
    ...
    <body>
        ...
        <section>
            <article id="main">
                ...
                <?php foreach($allnews as $eachnews): ?>
                    <tbody>                  
                        <tr>                                    
                            <td><?php echo $eachnews['idNewsletter']; ?></td>
                            <td><?php echo $eachnews['subject']; ?></td>
                            <td><?php echo $eachnews['attachment']; ?></td>
                            <td>
                                <form action="update_newsletterform.php" method="post" id="update_newsletter">
                                    <input type="hidden" name="news_idEdit" value="<?php echo $eachnews['idNewsletter']; ?>" />                      
                                    <input id="editbutton" type="submit" class="roundcorner" type="button" value="EDIT" />
                                </form>

                                <form action="functions/delete_newsletter.php" method="post" id="delete_login">
                                    <input type="hidden" name="news_id" value="<?php echo $eachnews['idNewsletter']; ?>" />                      
